...
*Description*
 ...
 Both search types execute searches on taxonomic data harvested from - currently - two data sources, i.e. a. Catalogue_of_life_, b. Nederlands_Soortenregister_. It searches a predefined subset of indexed taxon document fields and returns in JSON responses multilingual taxon documents from basically species and subspecies. 
 ...
 *url*
  The basic request url for free text search is:
  <base url>/specimen/search/?_search=[term], e.g. http:/10.42.1.177:8080/v0/specimen/search/?_search=koolmees
      
  The basic request url for indexed field search is:
  <base url>/specimen/search/?indexedField1=[term]&indexedField2=[term], e.g. http://10.42.1.177:8080/v0/specimen/search/?typeStatus=holotype
 ...
 *general meta parameters in an url*
  ...
  ===========   =========================================================================================================
   ...
   ===========   =========================================================================================================
   _maxResults   - _maxResults instructs NBA to return maximum amount of search results per page 
                 - example: <base url>/specimen/search/?_search=Abies&_maxResults=20, shows maximum amount of 20 documents in responses
                 - default setting: _maxResults=10
   _offset       - _offset instructs NBA to start filling first response from search result no = offset value + 1
	             - example: <base url>/specimen/search/?_search=Abies&_offset=15. In first response search result no 16 is first document in response 
			     - default setting: _offset=0
   ===========   =========================================================================================================
   ...
   _sort            - _sort instructs NBA to return responses sorted on a single specified indexed field included in Specimen documents.
	                - example: <base url>/specimen/search/?genusOrMonomial=Abies&_sort=identifications.scientificName.genusOrMonomial
	                - default setting: _sort = _score
   ...
   _sortDirection   - _sortDirection instructs NBA on sorting direction, i.e. either descending or ascending
	                - example: <base url>/specimen/search/?genus=Abies&_sort=_score&_sortDirection=DESC 
		            - default setting: _sortDirection=ASC
   ==============   ======================================================================================================
	  
  *specific meta parameters for indexed field search*
   For indexed fields search extra search meta parameters are available. 
   
   ===========   =========================================================================================================
   Name          Description
   ===========   =========================================================================================================
   _andOr		 - _andOr instructs NBA to use logical operator AND (conjunction) for multiple indexed field search
                 - example: <base url>/specimen/search/?genus=Abra&species=alba&_andOr=AND
                 - default setting: _andOr=AND
   ===========   =========================================================================================================
 ...
 *url*
  The basic request url for free text search is:
  <base url>/specimen/name-search/?_search=[term], e.g. http://10.1.42.177:8080/v0/?_search=Larus

  The basic request url for indexed field search is:
  <base url>/specimen/name-search/?indexedField1=[term]&indexedField2, e.g. <base url>/specimen/name-search/?typeStatus=holotype
