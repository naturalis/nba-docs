...
Both search types execute searches through taxonomic data harvested from - currently - two data sources, i.e. a. :ref:`Catalogue of life <Catalogue_of_life>`, b. Nederlands_Soortenregister_. It searches a `list of indexed taxon document fields`_ and returns taxon multilingual taxon documents in JSON responses from basically species and subspecies.
